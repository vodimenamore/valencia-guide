...
const CONTENT = {
  ...
  kids: {
    ...
    items: [
      { name: "Oceanogràfic", desc: "Europe's largest aquarium, inside the City of Arts and Sciences. Sharks, beluga whales, dolphins, penguins, jellyfish — spread across outdoor pavilions so it never feels overwhelming. Book tickets online in advance, the queue on the day is long. 🎟 €33.70 adults, €25.25 children (3–12), free under 3. Triple combo with Science Museum + Hemisfèric: €47.75 adults (valid 3 consecutive days). 15% discount with the Valencia Tourist Card.", address: "Av. del Professor López Piñero, 5" },
      ...
      { name: "Bioparc Valencia", desc: "A zoo with no visible barriers — animals live in recreated African habitats and you walk through them. Gorillas, elephants, lions, hippos. Much better than a traditional zoo. Half a day is enough; it's at the western end of the Turia garden. 🎟 €23.80 adults, €18 children (3–12), free under 3. Book online for a small discount; combined family tickets available.", address: "Av. Pío Baroja, 3" },
      { name: "Museu de les Ciències (Science Museum)", desc: "Hands-on interactive science museum in Calatrava's stunning skeleton building. Kids can touch and experiment with everything. Shows are in Spanish but most exhibits are physical and language-independent. Combine with Oceanogràfic next door. 🎟 €8 adults, €6.25 children (3–12), free under 3. Included in the triple combo with Oceanogràfic + Hemisfèric (€47.75 adults). 15% discount with the Valencia Tourist Card.", address: "Av. del Professor López Piñero, 1" },
